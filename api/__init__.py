"""
Welcome to the documentation for the BlogHome API!
...
[project's source code](https://github.com/Usool-Data-Science/BlogHome) using
the [APIFairy](https://github.com/miguelgrinberg/apifairy) Flask extension.

## Introduction

BlogHome-API is an easy to use web API for creating social blogs. It is an ideal
...
BlogHome API provides all the base features required to implement a
...
If you are running Bloghome API yourself while developing your front end,
...
| `MAIL_DEFAULT_SENDER` | `donotreply@bloghome.example.com` | The default sender to use for emails. |
